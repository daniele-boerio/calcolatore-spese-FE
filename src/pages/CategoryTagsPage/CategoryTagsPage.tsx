...
import UpdateCategoryDialog from "../../components/Dialog/UpdateCategoryDialog/UpdateCategoryDialog";
import UpdateTagDialog from "../../components/Dialog/UpdateTagDialog/UpdateTagDialog";
import CreateCatTagDialog from "../../components/Dialog/CreateCatTagDialog/CreateCatTagDialog";
import { ConfirmPopup, confirmPopup } from "primereact/confirmpopup";

const CategoryTagsPage: React.FC = () => {
  const dispatch = useAppDispatch();
  const categorie = useAppSelector((state) => state.categoria.categorie);
  const CatLoading = useAppSelector((state) => state.categoria.loading);
  const TagLoading = useAppSelector((state) => state.tag.loading);
